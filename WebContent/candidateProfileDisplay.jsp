...
if(list9!=null&&list9.size()>0)
{
	...
	{
		CandidateProfile cp=(CandidateProfile)list9.get(i);%>
...
<div class="panel-body">
 ...
 <font><%=cp.getCan_education() %></font>
  ...
  <div class="form-group">
    <label for="can_branch">Branch:</label>
    <font><%=cp.getCan_branch() %></font>
  </div> 
...
<div class="well"><div class="panel panel-default">
<div class="panel-body">
 <font color="blue"><h2><b><span class="glyphicon glyphicon-education"></span> Experiance Details</b></h2></font>
  <hr>
  
        <div class="form-group">
  <label for="sel1">Total Experiance :</label>
 <font><%=cp.getCan_experience() %></font>
   </div>
   ...
   <font><%=cp.getCan_experience_details() %></font>
  </div> 
 
  
  <div class="form-group">
    <label for="can_branch">Current CTC:</label>
    <font><%=cp.getCan_ctc() %></font>
  </div> 
